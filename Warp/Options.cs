...
namespace Warp
{
    ...
    public class OptionsPicking : WarpBase
    {
		...
		private string _MicroscopeXMLPath = "";
		[WarpSerializable]
		[JsonProperty]
		public string MicroscopeXMLPath
		{
			get { return _MicroscopeXMLPath; }
			set { if (value != _MicroscopeXMLPath) { _MicroscopeXMLPath = value; OnPropertyChanged(); } }
		}
